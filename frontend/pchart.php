...
$result = $db->query('SELECT * FROM data ORDER BY id DESC LIMIT 30');
$row = array();
$i = 0;
...
, "R"=>0, "G"=>0, "B"=>0);
$myPicture->drawText(300,25,"Bot Chart 30",$TextSettings);

$myPicture->setShadow(FALSE);
$myPicture->setGraphArea(10,40,550,190);
...
$myPicture->drawLegend(486,205,$Config);
